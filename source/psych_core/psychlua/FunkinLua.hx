...
import psych_core.objects.StrumNote;
import psych_core.objects.Note;
import psych_core.objects.NoteSplash;
import psych_core.objects.Character;

import psych_core.states.MainMenuState;
...
import psych_core.psychlua.LuaUtils.LuaTweenOptions;
#if HSCRIPT_ALLOWED
import psych_core.psychlua.HScript;
#end
import psych_core.psychlua.DebugLuaText;
import psych_core.psychlua.ModchartSprite;
import psych_core.psychlua.ModchartAnimateSprite;
