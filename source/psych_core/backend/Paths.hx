...
class Paths
{
	...
	private static function remapDoidoPath(file:String):String
	{
		return file;
	}
	...
	inline static public function getFolderPath(file:String, folder = "shared")
		return 'assets/Psych/$folder/$file';

	static public function getSharedPath(file:String = '')
	{
		var path = 'assets/Psych/$file';
		if (OpenFlAssets.exists(path)) return path;
		return 'assets/Psych/shared/$file';
	}
