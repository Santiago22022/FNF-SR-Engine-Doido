package psych_core.states.stages;

import openfl.filters.ShaderFilter;
import psych_core.shaders.RainShader;
...
import psych_core.cutscenes.CutsceneHandler;
...
class PhillyStreets extends BaseStage
{
	...
	{
		if (abot == null || !abot.visible) return; // Safety check
		...
		if(finishInstantly && abot.eyes != null && abot.eyes.visible) 
