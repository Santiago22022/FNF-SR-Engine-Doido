package psych_core.states.editors;
...
import psych_core.states.editors.content.MetaNote;
import psych_core.states.editors.content.VSlice;
import psych_core.states.editors.content.Prompt;
import psych_core.states.editors.content.*;
...
import psych_core.objects.HealthIcon;
...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	function addFileTab()
	{
		...
		var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Exit', function()
		{
			...
			MusicBeatState.switchState(new psych_core.states.editors.MasterEditorMenu());
	...
	function updateNotesRGB()
	{
		...
		for (note in notes)
		{
			...
			{
				var data = psych_core.backend.NoteTypesConfig.loadNoteTypeData(note.noteType);
	...
	override function destroy()
	{
		...
		psych_core.backend.NoteTypesConfig.clearNoteTypesData();
