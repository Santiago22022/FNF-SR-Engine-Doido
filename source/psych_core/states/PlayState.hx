...
import psych_core.backend.Highscore;
import psych_core.backend.StageData;
import psych_core.backend.WeekData;
import psych_core.backend.Song;
import psych_core.backend.Rating;
...
import psych_core.cutscenes.DialogueBoxPsych;

import psych_core.states.StoryMenuState;
import psych_core.states.FreeplayState;
import psych_core.states.editors.ChartingState;
import psych_core.states.editors.CharacterEditorState;

import psych_core.substates.PauseSubState;
import psych_core.substates.GameOverSubstate;

#if !flash
import openfl.filters.ShaderFilter;
#end

import psych_core.shaders.ErrorHandledShader;

import psych_core.objects.VideoSprite;
import psych_core.objects.Note.EventNote;
import psych_core.objects.*;
import psych_core.states.stages.*;
import psych_core.states.stages.objects.*;

#if LUA_ALLOWED
import psych_core.psychlua.*;
#else
import psych_core.psychlua.LuaUtils;
import psych_core.psychlua.HScript;
#end

#if HSCRIPT_ALLOWED
import psych_core.psychlua.HScript.HScriptInfos;
import crowplexus.iris.Iris;
import crowplexus.hscript.Expr.Error as IrisError;
import crowplexus.hscript.Printer;
#end

import psych_core.psychlua.CustomSubstate;
import psych_core.backend.NoteTypesConfig;
...
class PlayState extends MusicBeatState
{
	...
	private var luaDebugGroup:FlxTypedGroup<psych_core.psychlua.DebugLuaText>;
	#end
	...
	override public function create()
	{
		...
		#if (LUA_ALLOWED || HSCRIPT_ALLOWED)
		luaDebugGroup = new FlxTypedGroup<psych_core.psychlua.DebugLuaText>();
	...
	public function addTextToDebug(text:String, color:FlxColor) {
		var newText:psych_core.psychlua.DebugLuaText = luaDebugGroup.recycle(psych_core.psychlua.DebugLuaText);
		newText.text = text;
		newText.color = color;
		...
		luaDebugGroup.forEachAlive(function(spr:psych_core.psychlua.DebugLuaText) {
